  ...
  <main>
    <div id="map" ref="map">
      ...
      <div id="circleLegend" class="circleLegend">
        <div class="icon-item">
          <img src="/images/CIRCLE-01.svg" alt="1-2 icon" />1-2 يوم
        </div>
        <div class="icon-item">
...
export default {
  ...
  mounted() {
    ...
    `;
        ...
        //     if (markerCategory === category || category === "All") {
        //       markerElement.style.display = ""; // Show marker
        //     } else {
          ...
          if (index >= 0) {
            ...
            if (item && !item.clicked) {
              ...
              map.markers.forEach((marker) => {
                ...
                // Call this function to show only `setMarkerHTML2` markers
        ...
        function getColorForCount(strikeType) {
          ...
          switch (strikeType) {
            ...
            case "قذائف مدفعية":
              return { color: "#6c5a44", offsetX: 15, offsetY: 15 };
            case "فسفوري":
              return { color: "#ed1c24", offsetX: 15, offsetY: 0 };
            case "قنابل مضيئة":
              return { color: "#00a651", offsetX: 0, offsetY: 15 };
            case "غير مؤكّد":
              return { color: "black", offsetX: 20, offsetY: 0 };
            default:
              return { color: "gray", offsetX: 20, offsetY: 20 }; // Default color and offset values for unknown strike types
          }
        }
        ...
        function setMarkerHTML2(count, strikeTarget) {
          ...
          if (count > 0) {
            ...
            switch (strikeTarget) {
              case "بيت/مبنى":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -40px; left: 0;" data-category="ضحايا مدنيين">' +
              ...
              case "سيارة/دراجة":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -40px; left: -20px;" data-category="ضحايا مدنيين">' +
              ...
              case "مدرسة/مستشفى/مسجد":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -40px; left: -40;" data-category="ضحايا مدنيين">' +
              ...
              case "صحافة":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -20px; left: 0;" data-category="ضحايا مدنيين">' +
              ...
              case "جيش لبناني":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -20px; left: -20px;" data-category="ضحايا مدنيين">' +
              ...
              case "قوات حفظ السلام":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -20px; left: -40px;" data-category="ضحايا مدنيين">' +
              ...
              case "دواجن/زراعة/صيد":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -60px; left: 0;" data-category="ضحايا مدنيين">' +
              ...
              case "دفاع مدني/إسعاف":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -60px; left: -20px;" data-category="ضحايا مدنيين">' +
              ...
              case "غابات/ أحراج":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -60px; left: -60px;" data-category="ضحايا مدنيين">' +
              ...
              case "مشاريع حيوية/ بنى تحتية":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -60px; left: -40px;" data-category="ضحايا مدنيين">' +
              ...
              case "مقبرة":
                markerHTML =
                  '<div style="position: absolute; display: inline-block; top: -80px; left: -80px;" data-category="ضحايا مدنيين">' +
              ...
              // Add cases for other strike targets if needed
              default:
        ...
        function displayStrikeTargetsAndVictims(targetData, centroidData) {
          ...
          Object.entries(victimCounts).forEach(([key, totalVictims]) => {
            ...
            if (centroidFeature) {
              ...
              // Check if markerHTML is generated
              if (markerHTML) {
                const markerElement = markerHTML.firstChild;

                // Set the data-victims-count attribute for filtering purposes
        ...
        function updateMapData() {
          ...
          // const rangeImagePaths = {
          //   "1-2": "/images/1-2.svg",
          //   "3-6": "/images/3-6.svg",
          //   "7-12": "/images/7-12.svg",
          //   "13-24": "/images/13-24.svg",
          //   "25-48": "/images/25-48.svg",
          //   "49-96": "/images/49-96.svg",
          //   // Add more ranges and corresponding image paths as needed
          // };
